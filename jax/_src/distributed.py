  ...
  def initialize(self,
    ...
    if process_id == 0:
      ...
      if xla_extension_version >= 179:
        ...
        self.service = xla_extension.get_distributed_runtime_service(
            coordinator_address, num_processes, True) # config.jax_coordination_service was removed in JAX 0.4.15
    ...
    if xla_extension_version >= 179:
      ...
      self.client = xla_extension.get_distributed_runtime_client(
          coordinator_address, process_id, True, # config.jax_coordination_service was removed in JAX 0.4.15
